...
import { FieldGroup, TextField } from "../ui/controls";
      ...
      <form ref={formRef} action={formAction} className="flex flex-col gap-6">
        <FieldGroup title="Logo and color">
          <TextField
            ...
            helper="Uploading files is not available yet — host the image publicly and paste its direct address (https://, ending in .png, .jpg, or .svg)."
          ...
          <div className="flex min-w-0 flex-col gap-1.5">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="h-9 w-12 shrink-0 cursor-pointer rounded-md border border-input bg-background p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40"
              />
              <Input
                id={hexId}
                name="primaryColor"
            ...
            <p id={`${hexId}-helper`} className="text-xs text-muted-foreground">
              A 6-digit hex color, such as #1E3A8A. Leave blank for the default
              dark accent.
            </p>
            {colorError ? (
              <p
